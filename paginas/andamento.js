...
class Andamento extends Component{
  ...
  ratingCompleted =() =>{
	...
	render(){
		return(
				<Cabecalho navigation={this.props.navigation} ativo="andamento">
				       <View style={[styles.Centro, {flexDirection: 'column'}]}>  
                <View style={[styles.Centro, {flexDirection: 'column'}]}>
                  <Image style={[styles.imagem]} source={require('../img/reading.png')}/>  
                  ...
                  Acompanhe a leitura do seu livro, com avaliação e acompanhamento de página
                  </Text>
                </View>
